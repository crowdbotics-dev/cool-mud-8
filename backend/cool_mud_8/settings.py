"""
Django settings for cool_mud_8 project.
...
WSGI_APPLICATION = 'cool_mud_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cool_mud_8 API",
    "DESCRIPTION": "API documentation for cool_mud_8 App",
    "VERSION": "v1",
}
